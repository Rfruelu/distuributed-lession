 ...
 */
public class MyKafkaConsumerFore extends Thread {


    private static final Logger LOGGER = LoggerFactory.getLogger(MyKafkaConsumerFore.class);

    private final KafkaConsumer kafkaConsumer;


    public MyKafkaConsumerFore(String topic) {
         ...
         */
        properties.put(ConsumerConfig.GROUP_ID_CONFIG, "MyKafkaConsumer3");
        ...
        TopicPartition topicPartition1 = new TopicPartition("test0811", 0);
    ...
    public static void main(String[] args) {
      //  new MyKafkaConsumerFore("test").start();

        int abs = Math.abs("MyKafkaConsumer3".hashCode() % 50);
