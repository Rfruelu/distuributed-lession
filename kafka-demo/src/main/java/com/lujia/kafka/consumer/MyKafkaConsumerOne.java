 ...
 */
public class MyKafkaConsumerOne extends  Thread{


    private static final Logger LOGGER= LoggerFactory.getLogger(MyKafkaConsumerOne.class);

    private final KafkaConsumer kafkaConsumer;


    public MyKafkaConsumerOne(String topic){
    ...
    public static void main(String[] args) {
        new MyKafkaConsumerOne("test").start();
    }
}
